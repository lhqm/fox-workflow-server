  ...
  <div class="my-process-designer">
    <div class="my-process-designer__header">
      ...
      <template v-if="!$slots['control-header']">
        <el-button-group key="file-control">
          <el-tooltip class="item" effect="dark" content="查看/配置流程基本信息" placement="bottom">
            <el-button type="danger" size="mini" @click="showProcessPro"
            ><i class="fa fa-save"> 流程属性 </i></el-button
            >
          </el-tooltip>
          ...
          <el-tooltip effect="light">
            ...
            <el-button :size="headerButtonSize" :type="headerButtonType" icon="el-icon-download"
              >下载文件</el-button
            >
          </el-tooltip>
          <el-tooltip effect="light">
            ...
            <el-button :size="headerButtonSize" :type="headerButtonType" icon="el-icon-view"
              >预览</el-button
            >
          </el-tooltip>
        </el-button-group>
    ...
    >
      <div class="drawer-content">
        <process-properties :deploy-m-name="processNewName"
...
<script>
  ...
  import ProcessProperties from "@/components/designercomponents/ProcessProperties";
  ...
  export default {
    ...
    methods: {
      ...
      async createNewDiagram(xml) {
        ...
        if(this.processId==''){
          this.processNewId=newId;
        }
        else{
          this.processNewId=this.processId;
        }
        let newName = this.deployMName || `业务流程_${new Date().getTime()}`;
        if(this.deployMName==''){
          this.processNewName=newName;
        }
        else{
          this.processNewName=this.deployMName;
        }
      ...
      showProcessPro(){
        this.bpmElement=this.bpmnModeler;
        let processElement=this.bpmElement.get("elementRegistry").find(el => el.type === "bpmn:Process");
        let businessObject=JSON.parse(JSON.stringify(processElement.businessObject));
        this.processNewName=businessObject["name"];
        this.dialogVisible=true;
      },
      saveEdit(){
        this.$refs.properties.saveEdit();
      },
      cloaseDialog() {
