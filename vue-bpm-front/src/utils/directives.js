...
/*
 *  使用方法
 *  将以下代码复制到一个directives.js文件中，然后在入口文件main.js中导入：import ‘./utils/directives.js’；
...
Vue.directive('dialogDragBPMN', {
  bind(el, binding, vnode, oldVnode) {
    ...
    if (isFullScreen === true) {
      ...
      nowMarginTop = document.body.clientHeight;
