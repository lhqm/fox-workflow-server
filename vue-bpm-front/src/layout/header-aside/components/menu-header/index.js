  ...
  render(h) {
    return (
      <div
        ...
        ref="page"
      >
        <div ref="content" class="theme-header-menu__content" flex-box="1" flex>
          <div
            ...
            ref="scroll"
          >
            <el-menu mode="horizontal" defaultActive={this.active} onSelect={this.handleMenuSelect}>
