          ...
          <template slot-scope="scope">
            <div class="operation-btn">
                ...
                <el-popconfirm title="您确定要删除吗？"
                    ...
                    <el-button icon="el-icon-delete" plain slot="reference" type="text" class="btn-danger">删除</el-button>
                </el-popconfirm>
            </div>
          </template>
        </el-table-column>
        ...
        <div class="drawer-content" style="height: 100%;">
          ...
          >
            <el-row>
              ...
              <el-col :span="12">
                <el-form-item label="岗位编号" prop="id" v-if="isAdd==false">
...
<script>
import {positionListPage, addPosition, updatePosition, deletePosition,getStionUsers} from '@/api/orgm/orgm'
  ...
  export default {
    ...
    methods:{
      ...
      async getStionUser(){
        const res=await getStionUsers(this.userParams);
        if(res.error=="200"){
