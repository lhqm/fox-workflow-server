                    ...
                    <el-tab-pane  name="rollBack">
                      ...
                      >
                        ...
                        <el-form-item label="回滚原因" prop="rollBackMsg">
                          <el-input type="textarea" :rows="3" v-model="rollBackForm.rollBackMsg"></el-input>
                        </el-form-item>
                    ...
                    <el-tab-pane  name="setEndTask">
                      ...
                      >
                         <el-form-item label="结束意见" prop="actionMsg">
                          <el-input type="textarea" :rows="3" v-model="setEndTask.actionMsg"></el-input>
                        </el-form-item>
                    ...
                    <el-tab-pane  name="deleteProce">
                      ...
                      >
                        <el-form-item label="删除原因" prop="actionMsg">
                          <el-input type="textarea" :rows="3" v-model="deleteProce.actionMsg"></el-input>
                        </el-form-item>
...
import {
  getApprovalTracks, getUserTaskTrack
