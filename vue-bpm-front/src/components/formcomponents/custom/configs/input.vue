<template>
  <div v-show="props.compType === 'input'">
    ...
    <el-form-item label="只读" label-width="80px">
      <el-switch v-model="props.readonly"></el-switch>
    </el-form-item>
    <el-form-item label="前置图标" label-width="80px">
    ...
    <el-form-item label="后置图标" label-width="80px">
    ...
    <el-form-item label="前缀" label-width="80px">
      <el-input v-model="props.prepend"> </el-input>
    </el-form-item>
    <el-form-item label="后缀" label-width="80px">
    ...
    <el-form-item label="验证类型" label-width="80px">
