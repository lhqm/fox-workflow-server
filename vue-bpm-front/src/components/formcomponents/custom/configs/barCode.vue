<template>
  <div v-show="props.compType === 'barCode'">
    ...
    <el-form-item label="标签文字" v-show="props.showLabel" label-width="80px">
      <el-input class="input" v-model="props.label"></el-input>
    </el-form-item>
    <el-form-item label="标签长度" v-show="props.showLabel" label-width="80px">
      <el-input-number v-model="props.labelWidth"  :min="1" :max="200"></el-input-number>
    </el-form-item>
    <el-form-item label="占用列数" v-show="props.span" label-width="80px">
      <el-input-number v-model="props.span"  :min="1" :max="24"></el-input-number>
    </el-form-item>
    <el-form-item label="条码值" label-width="80px">
      <el-input v-model="props.value"></el-input>
    </el-form-item>
    <el-form-item label="条码颜色" v-show="props.lineColor" label-width="80px">
      <el-color-picker v-model="props.lineColor" @change="handlerChangeBarCode"/>
    </el-form-item>
    <el-form-item label="背景颜色" v-show="props.background" label-width="80px">
    ...
    <el-form-item label="条码高度" label-width="80px">
      <el-input-number v-model="props.height"  :min="10" :max="100" :step="1"></el-input-number>
    </el-form-item>
    <el-form-item label="显示值" label-width="80px">
