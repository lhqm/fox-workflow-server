<template>
  <div v-show="props.compType === 'cascader'">
    ...
    <el-form-item label="完整路径" label-width="80px">
    ...
    <el-form-item label="展开方式" label-width="80px">
    ...
    <el-form-item label="任一级可选" label-width="80px">
    ...
    <div v-show="props.dataType === 'dynamic'">
      ...
      <el-form-item label="显示标识" label-width="80px">
        <el-input v-model="props.props.props.label"></el-input>
      </el-form-item>
      <el-form-item label="值标识" label-width="80px">
        <el-input v-model="props.props.props.value"></el-input>
      </el-form-item>
      <el-form-item label="下级标识" label-width="80px">
