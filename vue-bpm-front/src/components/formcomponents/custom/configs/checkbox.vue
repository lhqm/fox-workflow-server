<template>
  <div v-show="props.compType === 'checkbox'">
    ...
    <el-form-item label="提示符" label-width="80px">
      <el-input class="input" v-model="props.placeholder" placeholder="请输入提示符" />
    </el-form-item>
    <el-form-item label="表单栅格" label-width="80px">
      <el-slider
        class="input"
        v-model="props.span"
        :max="24"
    ...
    <el-form-item label="栅格间隔" label-width="80px">
    ...
    <el-form-item label="垂直" label-width="80px">
      <el-switch v-model="props.vertical"></el-switch>
    </el-form-item>
    <el-form-item label="最小数量" label-width="80px">
      <el-input-number v-model="props.min" :min="1"></el-input-number>
    </el-form-item>
    <el-form-item label="最大数量" label-width="80px">
      <el-input-number v-model="props.max" :min="1"></el-input-number>
    </el-form-item>
    <el-form-item label="选项样式" label-width="80px">
      <el-radio-group v-model="props.optionType">
        <el-radio-button label="default">默认</el-radio-button>
        <el-radio-button label="button">按钮</el-radio-button>
      </el-radio-group>
    </el-form-item>
    <el-form-item label="显示边框" label-width="80px">
      <el-switch v-model="props.border"></el-switch>
    </el-form-item>
    <el-form-item label="选项尺寸" v-show="props.border || props.optionType === 'button'" label-width="80px">
    ...
    <div v-show="props.dataType === 'dynamic'">
      <el-form-item label="选择字典" label-width="80px">
        <el-select v-model="props.action" filterable @change="handlerChangeDataType">
          <el-option v-for="i in typeList" :key="i.no" :value="i.no" :label="i.name" />
        </el-select>
      </el-form-item>
    </div>
  </div>
...
<script>
  ...
  import {getDictList} from "@/api/system/dicts";
  /**
   * input的配置项
   */
  let vm = {
