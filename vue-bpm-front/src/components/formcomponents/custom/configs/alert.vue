<template>
  <div v-show="props.compType === 'alert'">
    ...
    <el-form-item label="辅助文字" label-width="80px">
      <el-input class="input" v-model="props.description"></el-input>
    </el-form-item>
    <el-form-item label="关闭" label-width="80px">
      <el-switch v-model="props.closable"></el-switch>
    </el-form-item>
    <el-form-item label="居中" label-width="80px">
      <el-switch v-model="props.center"></el-switch>
    </el-form-item>
    <el-form-item label="关闭按钮自定义文本" label-width="80px">
      <el-input class="input" v-model="props['close-text']"/>
    </el-form-item>
    <el-form-item label="显示图标" label-width="80px">
